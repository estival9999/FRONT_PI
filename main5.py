...
class SistemaTFT:
    ...
    def mostrar_menu_principal(self):
        ...
        for i, (texto, comando, cor) in enumerate(botoes):
            btn = ctk.CTkButton(
                ...
                height=66,  # Altura ajustada para preencher espaço
                command=comando,
                font=ctk.CTkFont(size=16, weight="bold"),
                fg_color=cor,
                hover_color=cor,
    ...
    def _criar_pre_gravacao(self):
        ...
        # Botões no topo - garantir visibilidade
        frame_btns = ctk.CTkFrame(self.frame_atual, height=50, fg_color=self.cores["fundo"])
        ...
        frame_form.pack(fill="both", expand=True, padx=10, pady=(5, 10))
